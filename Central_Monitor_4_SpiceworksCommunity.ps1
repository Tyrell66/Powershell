...
$EmailFrom = "PowerShell.COX1@clearstream.com" 
$EmailTo = "olivier.theizen@clearstream.com" 
$EmailSubject = "Server event notification."   
   
$SMTPServer = "vmgatedmz.cedelgroup.com" 
$SMTPAuthUsername = "" 
$SMTPAuthPassword = "" 
...
#Send email to the itsupport@renewaire.com group if there were any monitored events found. 
